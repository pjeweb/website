...
let usrSearch = document.getElementById('usersearchmodal')
let usrInput = usrSearch.querySelector('input#userSearchInput')
let usrSelectBtn = usrSearch.querySelector('button#userSearchSelect')
let usrSearchForm = usrSearch.querySelector('form#userSearchForm')
let giftMsgInput = usrSearch.querySelector('textarea#giftmessage')
let hasErrors = false
let giftUsername = ''
...
const showLookupError = function (message) {
    ...
    usrSearch.querySelectorAll('label.error').forEach(labelElement => {
...
const checkEmpty = function (e) {
    ...
    usrSearch.querySelectorAll('label.error')
...
usrSearchForm.addEventListener('submit', function (e) {
    ...
    usrSearch.querySelectorAll('label.error').forEach(labelElement => labelElement.classList.add('hidden'))
